...
export const HornetBadge: React.FC<HornetBadgeProps> = ({
  ...
  return (
    <div
      className={`inline-flex items-center rounded-full bg-slate-950/80 border border-slate-700/80 backdrop-blur-md font-mono tracking-tight ${levelInfo.color} ${sizeClasses[size]} ${className}`}
